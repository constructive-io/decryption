...
import { asafenumber, bitGet, validateObject, type TArg, type TRet } from '../utils';
import { FpInvertBatch, FpPow, type IField, validateField } from './modular';
 ...
 *
 * ```ts
 * import { grainGenConstants } from './poseidon';
 * import { Field } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { grainGenConstants, validateOpts } from './poseidon';
 * import { Field } from './modular';
 * const Fp = Field(17n);
 * const constants = grainGenConstants({ Fp, t: 2, roundsFull: 8, roundsPartial: 8 });
 ...
 *
 * ```ts
 * import { grainGenConstants, poseidon } from './poseidon';
 * import { Field } from './modular';
 * const Fp = Field(17n);
 * const constants = grainGenConstants({ Fp, t: 2, roundsFull: 8, roundsPartial: 8 });
 ...
 *
 * ```ts
 * import { PoseidonSponge, grainGenConstants, poseidon } from './poseidon';
 * import { Field } from './modular';
 * const Fp = Field(17n);
 * const constants = grainGenConstants({ Fp, t: 2, roundsFull: 8, roundsPartial: 8 });
 * const hash = poseidon({ ...constants, Fp, t: 2, roundsFull: 8, roundsPartial: 8, sboxPower: 3 });
 ...
 *
 * ```ts
 * import { grainGenConstants, poseidonSponge } from './poseidon';
 * import { Field } from './modular';
 * const Fp = Field(17n);
 * const constants = grainGenConstants({ Fp, t: 2, roundsFull: 8, roundsPartial: 8 });
