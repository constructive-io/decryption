 ...
 *
 * ```ts
 * import { FFTCore, rootsOfUnity } from './fft';
 * import { Field } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { FFT, rootsOfUnity } from './fft';
 * import { Field } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { poly, rootsOfUnity } from './fft';
 * import { Field } from './modular';
 * const Fp = Field(17n);
