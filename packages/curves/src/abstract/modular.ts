 ...
 *
 * ```ts
 * import { Field, tonelliShanks } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpSqrt } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, validateField } from './modular';
 ...
 *
 * ```ts
 * import { Field, FpPow } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpInvertBatch } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpDiv } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpLegendre } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpIsSquare } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpSqrtOdd } from './modular';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpSqrtEven } from './modular';
 * const Fp = Field(17n);
