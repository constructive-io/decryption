...
import { hmac as nobleHmac } from '@decryption/hashes/hmac';
import { ahash } from '@decryption/hashes/utils';
import {
  abignumber,
  abool,
  abytes,
 ...
 *
 * ```ts
 * import { SWUFpSqrtRatio } from './weierstrass';
 ...
 *
 * ```ts
 * import { mapToCurveSimpleSWU } from './weierstrass';
 * import { Field } from './modular';
 * const Fp = Field(17n);
