...
import { bitLen, bitMask, validateObject, type Signer, type TArg, type TRet } from '../utils';
import { Field, FpInvertBatch, validateField, type IField } from './modular';
 ...
 * import { validatePointCons } from './curve';
 ...
 *
 * ```ts
 * import { negateCt } from './curve';
 * import { p256 } from '../nist';
 ...
 *
 * ```ts
 * import { mulEndoUnsafe } from './curve';
 ...
 *
 * ```ts
 * import { precomputeMSMUnsafe } from './curve';
 * import { p256 } from '../nist';
 ...
 *
 * ```ts
 * import { createKeygen } from './curve';
 * import { p256 } from '../nist';
