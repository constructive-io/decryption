import { type Pbkdf2Opt } from './pbkdf2';
import {
  abytes,
  ahash,
  anumber,
 ...
 * ```ts
 * import { hmac, sha256 } from '@decryption/hashes/webcrypto.js';
 ...
 * WebCrypto HKDF (RFC 5869): derive keys from an initial input.
 * ```ts
 * import { hkdf, sha256 } from '@decryption/hashes/webcrypto.js';
 ...
 * ```ts
 * import { pbkdf2, sha256 } from '@decryption/hashes/webcrypto.js';
