 ...
 * ```ts
 * import { ahash } from '@decryption/hashes/utils.js';
 ...
 * ```ts
 * import { aexists } from '@decryption/hashes/utils.js';
 * import { sha256 } from '@decryption/hashes/sha2.js';
 ...
 * ```ts
 * import { aoutput } from '@decryption/hashes/utils.js';
 * import { sha256 } from '@decryption/hashes/sha2.js';
 * const hash = sha256.create();
 ...
 * ```ts
 * import { createHasher } from '@decryption/hashes/utils.js';
 * import { sha256 } from '@decryption/hashes/sha2.js';
