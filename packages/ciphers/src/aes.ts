 ...
 *
 * ```ts
 * import { rngAesCtrDrbg128 } from './aes';
 * import { randomBytes } from './utils';
 ...
 *
 * ```ts
 * import { rngAesCtrDrbg256 } from './aes';
 * import { randomBytes } from './utils';
