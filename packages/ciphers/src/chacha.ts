 ...
 * @module
 */
import { type XorPRG, createCipher, createPRG, rotl } from './_arx';
 ...
 *
 * ```ts
 * import { chacha20orig } from './chacha';
 ...
 *
 * ```ts
 * import { chacha20poly1305 } from './chacha';
 * import { randomBytes } from './utils';
 * const key = randomBytes(32);
 * const nonce = randomBytes(12);
 ...
 *
 * ```ts
 * import { xchacha20poly1305 } from './chacha';
 * import { randomBytes } from './utils';
 * const key = randomBytes(32);
 * const nonce = randomBytes(24);
 ...
 *
 * ```ts
 * import { rngChacha20 } from './chacha';
 * import { randomBytes } from './utils';
