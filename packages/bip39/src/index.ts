...
import { pbkdf2, pbkdf2Async } from '@decryption/hashes/pbkdf2';
import { sha256, sha512 } from '@decryption/hashes/sha2';
import { abytes, anumber, randomBytes, type TArg, type TRet } from '@decryption/hashes/utils';
import { pbkdf2 as pbkdf2web, sha512 as sha512web } from '@decryption/hashes/webcrypto';
import { utils as baseUtils } from '@decryption/base';
 ...
 * ```ts
 * import { generateMnemonic } from '@decryption/bip39';
 * import { wordlist } from '@decryption/bip39/wordlists/english.js';
 ...
 * ```ts
 * import { mnemonicToEntropy } from '@decryption/bip39';
 * import { wordlist } from '@decryption/bip39/wordlists/english.js';
 ...
 * ```ts
 * import { entropyToMnemonic } from '@decryption/bip39';
 * import { wordlist } from '@decryption/bip39/wordlists/english.js';
 ...
 * ```ts
 * import { validateMnemonic } from '@decryption/bip39';
 * import { wordlist } from '@decryption/bip39/wordlists/english.js';
